...
const TOOL_DESCRIPTION =
  "Menjalankan satu pernyataan SQL pada PostgreSQL (default: read-only). Koneksi dari env POSTGRES_*; SELECT/EXPLAIN/TABLE/VALUES/SHOW baca diizinkan; INSERT/UPDATE/DELETE/DDL ditolak kecuali env ALLOW_* terkait diset. CTE (WITH ...) dan ROW_NUMBER() selalu ditolak. Hasil dikembalikan dalam format JSON.";
